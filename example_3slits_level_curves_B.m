...
%
%
[x,y] =  meshgrid([-2.5:0.01:2.5],[-1.1:0.01:1.1]);
z     =  x+i.*y;
for k=1:3
...
figure;
hold on
tv = [0.05,0.1,0.15,0.2,0.27,0.34,0.4,0.5,0.6,0.7,0.8,0.85,0.9,0.95];
...
set(gca,'YTick',[-1:1]);
set(gca,'LooseInset',get(gca,'TightInset'))
print -depsc fig_3slits_lcB
% print -dpdf  fig_3slits_lcB
%