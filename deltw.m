...
% parameter.
% The function delta_j(t) is defined in Page 697 in the paper:
% J. Liesen, O. Sète and M. Nasser, Fast and Accurate Computation of the
% Logarithmic Capacity of Compact Sets, Comput. Methods Funct. Theory  17 
% (2017) 689-713.
%
n  = length(t);
for k=1:pj
